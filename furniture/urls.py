...
urlpatterns = [
    ...
    #path('c/hiii', views.index1, name="c"),
    #path('<int:id>/<slug:slug>/hii', views.detail, name='detail'),
    
    #path('<slug:category_slug>/hi', views.index1, name='list'),
    path('auth/',include('autho.urls',namespace='autho')),
